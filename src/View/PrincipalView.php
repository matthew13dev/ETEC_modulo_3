...
<body class="w3-light-grey">
    ...
    <div class="w3-padding-large" id="main">
                ...
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-rest">
                        <input class="w3-input w3-border w3-round-large" name="txtCPF" type="text"
                            placeholder="123.456.789-00" value="">
                    </div>
                    <div class="w3-col" style="width:11%;">
                    ...
                    <div class="w3-rest">
                        <input class="w3-input w3-border w3-round-large" name="txtEmail" type="text"
                            placeholder="seuemail@email.com" value="">
                    </div>
                </div>
                <div class="w3-row w3-section">
        ...
        <div class="w3-padding-128 w3-content w3-text-grey" id="formacao">
            ...
            <form action="" method="post" class="w3-row w3-light-grey w3-text-blue w3-margin" style="width:45%;">
